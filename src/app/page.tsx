...
const features = [
  ...
  { icon: "✅", t: "Progress Tracking", d: "Mark sessions complete. Progress persists across devices — tied to your account." },
    ...
    <div style={{ fontFamily: "Georgia, serif", background: "#f7f4ef", minHeight: "100vh" }}>
      ...
      <nav style={{ background: "#0d1a2b", padding: "0 48px", borderBottom: "1px solid #1e3050", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", height: 64 }}>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <Link href="/sign-up" style={{ padding: "8px 20px", background: "#c0392b", color: "#fff", borderRadius: 5, fontFamily: "sans-serif", fontSize: 13, fontWeight: "bold", textDecoration: "none" }}>Get Started Free →</Link>
          </div>
        </div>
      </nav>
      ...
      <section style={{ background: "linear-gradient(160deg,#0d1a2b,#1a3a5c 60%,#0d1a2b)", color: "#fff", padding: "96px 48px 88px", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <p style={{ fontSize: 11, letterSpacing: 5, textTransform: "uppercase", color: "#7aadcf", marginBottom: 22, fontFamily: "sans-serif" }}>Independent Business Education Platform</p>
          <h1 style={{ fontSize: 50, fontWeight: "normal", lineHeight: 1.2, margin: "0 0 26px" }}>
            Master Business Fundamentals<br />
            <span style={{ color: "#f0c040" }}>Through Elite Case Method Study</span>
          </h1>
          <p style={{ fontSize: 17, color: "#a8c4dc", lineHeight: 1.8, margin: "0 auto 44px", fontFamily: "sans-serif", maxWidth: 640 }}>
            A self-directed, intensive curriculum built around real business cases and daily practice — the same method used in top business schools, now entirely on your own terms.
          </p>
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/sign-up" style={{ padding: "15px 44px", background: "#c0392b", color: "#fff", borderRadius: 6, fontSize: 16, fontFamily: "sans-serif", fontWeight: "bold", textDecoration: "none" }}>Start Learning Free →</Link>
      ...
      <section style={{ padding: "80px 48px", background: "#f7f4ef" }}>
        <div style={{ maxWidth: 1060, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            <h2 style={{ fontSize: 30, fontWeight: "normal", margin: "0 0 10px" }}>Everything you need to study seriously</h2>
            <p style={{ color: "#666", fontFamily: "sans-serif", fontSize: 15, margin: 0 }}>Built for learners who want real analytical muscle — not surface-level summaries.</p>
          </div>
      ...
      <section style={{ padding: "72px 48px", background: "#fff" }}>
        <div style={{ maxWidth: 1020, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            ...
            <h2 style={{ fontSize: 28, fontWeight: "normal", margin: "0 0 8px" }}>13 modules. Two tracks.</h2>
            <p style={{ color: "#888", fontFamily: "sans-serif", fontSize: 14, margin: 0 }}>Progress through core disciplines before advancing to applied subjects.</p>
          </div>
      ...
      <section style={{ padding: "72px 48px", background: "linear-gradient(135deg,#1a3a5c,#0d1a2b)", textAlign: "center" }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 15, color: "#7aadcf", fontFamily: "sans-serif", lineHeight: 1.7, margin: "0 0 28px" }}>Free account. Your progress and notes saved forever. Start Finance I today.</p>
          <Link href="/sign-up" style={{ padding: "16px 48px", background: "#c0392b", color: "#fff", borderRadius: 6, fontSize: 16, fontFamily: "sans-serif", fontWeight: "bold", textDecoration: "none" }}>Create Free Account →</Link>
        </div>
      </section>
      ...
      <footer style={{ background: "#080f18", padding: "22px 48px" }}>
        <p style={{ maxWidth: 1100, margin: "0 auto", fontSize: 11, color: "#3a5a70", fontFamily: "sans-serif", lineHeight: 1.7 }}>
          <strong style={{ color: "#4a7a9b" }}>Disclaimer:</strong> ApexMBA is an independent self-study platform not affiliated with Harvard University, Harvard Business School, or any other academic institution. All content is independently developed for personal educational use.
        </p>
      </footer>
    </div>
  );
